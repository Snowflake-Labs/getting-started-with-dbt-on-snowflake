select
    ...
    campaign_id,
    message_variation_api_id as variation_api_id,
    cast(null as varchar) as canvas_id,
    cast(null as varchar) as canvas_step_api_id,
...
from {{ source('braze_datalake', 'USERS_CAMPAIGNS_CONVERSION_SHARED') }}
