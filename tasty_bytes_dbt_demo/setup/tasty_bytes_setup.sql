...
GRANT USAGE ON SCHEMA TASTY_BYTES_DBT_DB.PROD TO ROLE DEMO_ROLE;
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA TASTY_BYTES_DBT_DB.PROD TO ROLE DEMO_ROLE;
GRANT ALL PRIVILEGES ON FUTURE TABLES IN SCHEMA TASTY_BYTES_DBT_DB.PROD TO ROLE DEMO_ROLE;
GRANT ALL PRIVILEGES ON ALL VIEWS IN SCHEMA TASTY_BYTES_DBT_DB.PROD TO ROLE DEMO_ROLE;
GRANT ALL PRIVILEGES ON FUTURE VIEWS IN SCHEMA TASTY_BYTES_DBT_DB.PROD TO ROLE DEMO_ROLE;
