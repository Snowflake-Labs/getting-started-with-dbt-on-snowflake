...
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA TASTY_BYTES_DBT_DB.DEV TO ROLE DEMO_ROLE;
GRANT ALL PRIVILEGES ON FUTURE TABLES IN SCHEMA TASTY_BYTES_DBT_DB.DEV TO ROLE DEMO_ROLE;
GRANT ALL PRIVILEGES ON ALL VIEWS IN SCHEMA TASTY_BYTES_DBT_DB.DEV TO ROLE DEMO_ROLE;
GRANT ALL PRIVILEGES ON FUTURE VIEWS IN SCHEMA TASTY_BYTES_DBT_DB.DEV TO ROLE DEMO_ROLE;

GRANT USAGE ON SCHEMA TASTY_BYTES_DBT_DB_/* Change the trigram */.PROD TO ROLE DEMO_ROLE;
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA TASTY_BYTES_DBT_DB_/* Change the trigram */.PROD TO ROLE DEMO_ROLE;
GRANT ALL PRIVILEGES ON FUTURE TABLES IN SCHEMA TASTY_BYTES_DBT_DB_/* Change the trigram */.PROD TO ROLE DEMO_ROLE;
GRANT ALL PRIVILEGES ON ALL VIEWS IN SCHEMA TASTY_BYTES_DBT_DB_/* Change the trigram */.PROD TO ROLE DEMO_ROLE;
GRANT ALL PRIVILEGES ON FUTURE VIEWS IN SCHEMA TASTY_BYTES_DBT_DB_/* Change the trigram */.PROD TO ROLE DEMO_ROLE;
