...
CREATE OR REPLACE NETWORK RULE CYARJAH_DB.public.dbt_network_rule
  MODE = EGRESS
  TYPE = HOST_PORT
...
-- country table build
CREATE OR REPLACE TABLE CYARJAH_DB.raw.country
(
...
CREATE OR REPLACE TABLE CYARJAH_DB.raw.franchise 
(
...
CREATE OR REPLACE TABLE CYARJAH_DB.raw.location
(
...
-- menu table build
CREATE OR REPLACE TABLE CYARJAH_DB.raw.menu
(
    menu_id NUMBER(19,0),
...
-- truck table build 
CREATE OR REPLACE TABLE CYARJAH_DB.raw.truck
(
...
CREATE OR REPLACE TABLE CYARJAH_DB.raw.order_header
(
...
CREATE OR REPLACE TABLE CYARJAH_DB.raw.order_detail 
(
...
CREATE OR REPLACE TABLE CYARJAH_DB.raw.customer_loyalty
(
    customer_id NUMBER(38,0),
    first_name VARCHAR(16777216),
    last_name VARCHAR(16777216),
